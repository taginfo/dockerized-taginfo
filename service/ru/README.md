...
generated : 2019-12-29:15:53  // template : ./setup/template/readme.jinja2
...
|---------------|------------------------|----------------|-------------|-------------------|----------------|----------|
| ru` | make GDNAME=russia taginfo-ru-ru`  |  Russia  | Россия |  "russia" | 127.0.0.1:24001| area_pct==99.9939% antimeridian |   