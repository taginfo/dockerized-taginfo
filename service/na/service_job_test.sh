...
GDNAME="north-america" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-na-ca /osm/sh/service_test_process.sh && docker-compose restart taginfo-na-ca 
...
GDNAME="north-america" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-na-us /osm/sh/service_test_process.sh && docker-compose restart taginfo-na-us 
