...
GDNAME="asia" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-as-in /osm/sh/service_process.sh && docker-compose restart taginfo-as-in 
...
GDNAME="japan" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-as-jp /osm/sh/service_process.sh && docker-compose restart taginfo-as-jp 
